...
async function handler(req: { method: string; body: { email: any; name: any; message: any; }; }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { message: string | { email: any; name: any; message: any; }; }): void; new(): any; }; }; }) {
  if (req.method === 'POST') {
